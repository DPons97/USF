 ...
 */
UCLASS()
class PROJECT_TIMEWARS_API UStrategyMovementComponent : public USpectatorPawnMovement
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	void SetCameraComponent(class UCameraComponent* NewCameraComponent) { this->CameraComponent = NewCameraComponent; }
